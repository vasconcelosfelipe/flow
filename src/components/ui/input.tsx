...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // h-11: alvo de toque confortável por padrão — a maioria dos
        // formulários já sobrescrevia isso manualmente (h-10/h-11) campo a
        // campo; agora quem não sobrescrever também sai correto.
